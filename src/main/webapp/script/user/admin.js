...
function updateProduct() {
    $.ajax({
        ...
        error: function (xhr, textStatus, errorThrown) {
            switch (xhr.status) {
                case 403:
                    alert('You don`t have permissions to update item with id=' + $('#id').val() + '!');
                    break;
                default:
                    alert('Some error thrown! Details : ' + xhr.status + ' ' + errorThrown);
                    break;
...
function deleteProduct() {
    $.ajax({
        ...
        success: function (data, textStatus, xhr) {
            findAllProducts();
            clearProductForm();
            alert('Item with id=' + $('#id').val() + ' successfully deleted!');
        },
        error: function (xhr, textStatus, errorThrown) {
            switch (xhr.status) {
                case 403:
                    alert('You don`t have permissions to delete item with id=' + $('#id').val() + '!');
                    break;
                default:
                    alert('Some error thrown! Details : ' + xhr.status + ' ' + errorThrown);
                    break;
